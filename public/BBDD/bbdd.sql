...
-- Volcando datos para la tabla virtualmarket.lineaspedidos: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla virtualmarket.pedidos: ~5 rows (aproximadamente)
