<section class="container p-0 pb-5" >
    <header class="header-section text-center font-weight-bold display-md-4 text-white m-0 p-3 p-md-5 bg-secondary"><?php echo $producto->nombre;?></header>
    <article class="row">
        <!--hola-->
        <!--<h1 class="col-12 display-4 text-center pb-2 mb-4 border-bottom"></h1>-->
        <div class="col-sm-4 col-md-5 m-3 m-md-4 m-lg-5">
            <?php echo "<img src='".IMG."/productos/$producto->foto' class='img-thumbnail img-detalle' alt='...'>" ?>
        </div>
        <div class="col-sm-6 col-md-4  m-3 m-md-4 m-lg-5 mr-5">
            <form class="form-horizontal" action="../carrito/" method="post" enctype="multipart/form-data" name="buy">
                ...
                <div class="form-group price_elem row">
                    ...
                    <div class="col-7 col-sm-8 col-md-9">
                        ...
                        <span ><sub><?php if(isset($monedas)){echo ("(".round(($monedas->currency_rates->EUR*$producto->precio/$monedas->currency_rates->USD/$monedas->currency_rates->USD),2)."$,  ".round(($monedas->currency_rates->EUR*$producto->precio/$monedas->currency_rates->USD/$monedas->currency_rates->GBP),2)."£)");} ?></sub></span>
                    </div>
                </div>
                <div class="form-group row">
