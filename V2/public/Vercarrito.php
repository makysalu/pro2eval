<?php 
        ...
        if(isset($_POST["Comprar"])){
            if(isset($_COOKIE["dniCliente"])){
                ...
                if(!isset($_COOKIE["idTemporal"])){
                    $idTemporal=time();
                    setcookie("idTemporal",$idTemporal,time()+36000);
                }
                else{
                    $idTemporal=$_COOKIE["idTemporal"];
                }
                $dniCliente="";
            }
            if(isset($_COOKIE["idCarro"])){
                $lineaCarro =new Carro($_COOKIE["idCarro"],"",$dniCliente,$idTemporal,$_POST["idProducto"],$_POST["cantidad"]);
                ...
                $lineaCarro=new Carro($newCookie,"",$dniCliente,$idTemporal,$_POST["idProducto"],$_POST["cantidad"]);
            }
